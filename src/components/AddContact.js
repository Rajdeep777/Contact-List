...
const AddContact = () => {
    ...
    return (
        <div className='container'>
            ...
            <div className='row'>
                <div className='col-md-6 shadow mx-auto p-5 form-bg form-hover'>
                    <form className='text-center' onSubmit={handelSubmit}>
                        ...
                        <div className='form-group mb-3'>
                            <input type='submit' value='Add Contact' className='btn btn-block btn-color btn-outline-dark btn-hover shadow' />
                        </div>
                    </form>
                </div>
            </div>
